...
pacman -S tlp ethtool lsb-release smartmontools x86_energy_perf_policy acpi_call
sed -i -E -e "s/#(START_CHARGE_THRESH_BAT0)=[0-9]+/\1=75/" /etc/tlp.conf
sed -i -E -e "s/#(STOP_CHARGE_THRESH_BAT0)=[0-9]+/\1=80/" /etc/tlp.conf
