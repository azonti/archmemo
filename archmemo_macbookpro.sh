...
pacstrap /mnt base base-devel linux linux-firmware dosfstools btrfs-progs dkms linux-headers bcwc-pcie-git vim man-db man-pages
...
## 全体の設定/ホットキー/入力メソッドをオンに
## 全体の設定/ホットキー/入力メソッドをオフに
